...
def retrieve_annotation(protein_id):
    ...
    #print "Retrieved %d annotation for %d protein" % (len(annotation),
    #        len(protein_id))
...
report_name_parts = filename.split("/")
report_name_parts = report_name_parts[2]
report_name_parts = report_name_parts.split("_")
report_name = report_name_parts[0]  + "_" + report_name_parts[1] + "_" + report_name_parts[2]  + "_" + report_name_parts[3] + "_" + report_name_parts[4]  + "_" + report_name_parts[5] + "_" + report_name_parts[6] + "_" + "orthologs" + "_" + "complete.txt"

print("The 'average evolutionary distance' report results have been saved in:")
print report_name 
...
#move the report to the directory with
#the input file
os.system("mv %s %s" %(report_name,filename_parent_dir))
